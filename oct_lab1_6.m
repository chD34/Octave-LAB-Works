...
for j = 1:N_v
    ...
    time = l/v;
    plot(x_1_values, x_2_values, 'DisplayName', ['v = ', num2str(v), ', Час: ', num2str(time)], 'Color', colors(j, :));
...
title('Траєкторія переміщення човна залежно від v', 'FontSize', 20);
grid on;
set(gca, 'FontSize', 16);
legend('show');
